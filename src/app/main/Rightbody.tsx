...
export default function RightBody({ filters }: RightBodyProps) {
  ...
  return (
    <div className="flex-1 bg-white p-6">
      <div className="w-full h-[300px] bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl shadow-lg mb-6">
      ...
      <div className="w-full bg-gray-50 rounded-xl p-4 mb-6 flex items-center justify-between">
